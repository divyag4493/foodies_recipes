...
class SeeAllFreshRecipes extends StatefulWidget {
  const SeeAllFreshRecipes({Key? key}) : super(key: key);

  @override
  State<SeeAllFreshRecipes> createState() => _SeeAllFreshRecipesState();
}

class _SeeAllFreshRecipesState extends State<SeeAllFreshRecipes> {
  @override
